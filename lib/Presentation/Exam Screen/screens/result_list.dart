...
//   final int examId;
//   final String tittle;
//   const ResultList({super.key, required this.examId, required this.tittle});
//   @override
...
//                 Center(
//                   child: Text(
//                     '${widget.tittle.toUpperCase().toString() ?? ''} RESULT',
...
class _ResultListState extends State<ResultList> {
  ...
  void _navigateToStudent(int id) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder:
            (_) => ExamResult(
              ...
              studentId: id, // 👈 pass ID
            ),
      ),
    );
  }

  void _navigateToStudentUnFinished() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder:
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    '${widget.tittle.toUpperCase()} RESULT',
                    style: GoogleFont.ibmPlexSans(
                      fontSize: 22,
                      fontWeight: FontWeight.w600,
                      color: AppColor.black,
                            ...
                            children: [
                              Container(
                                ...
                                child: TabBar(
                                  ...
                                  isScrollable: true,
                                  tabs: const [
                                    Tab(text: 'Mark Filled'),
                                    Tab(text: 'Mark Unfilled'),
                                  ],
                                  labelColor: AppColor.blue,
                                  unselectedLabelColor: AppColor.gray,
                                  indicator: const BoxDecoration(

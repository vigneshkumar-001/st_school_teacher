...
class _QuizScreenCreateState extends State<QuizScreenCreate> {
  ...
  Map<String, dynamic>? _validateAndBuildPayload() {
    ...
    // ✅ Build payload from reactive controller values
    return {
      ...
      "questions":
          questionList.map((q) {
            return {
              ...
              "options":
                  q.answers.map((a) {
                    return {"text": a.text.trim(), "isCorrect": a.isCorrect};
                  }).toList(),
            };
          }).toList(),
    };
  ...
  /*  Map<String, dynamic>? _validateAndBuildPayload() {
    bool hasError = false;
    final singleDateText = singleDateController.text.trim();
    final selectedSubjects = teacherClassController.selectedSubject.value;
    final selectedSubjectIds = selectedSubjects?.id;
    print('hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh${selectedSubjects?.name}');
    // reset flags
    setState(() {
      _classInvalid = false;
      _subjectInvalid = false;
